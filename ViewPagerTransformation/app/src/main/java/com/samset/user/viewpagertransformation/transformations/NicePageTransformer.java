package com.samset.user.viewpagertransformation.transformations;

import android.support.v4.view.ViewPager;
import android.view.View;

import com.samset.user.viewpagertransformation.R;


/**
 * Created by user on 13-Sep-16.
 */
public class NicePageTransformer implements ViewPager.PageTransformer {
